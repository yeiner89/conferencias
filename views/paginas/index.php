...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de PowerPlatform</p>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios para Power Platform Camp</p>

    <div class="boletos__grid">
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">Power Platform Camp</h4>
            <p class="boleto__plan">Presencial aplica sólo para Costa Rica</p>
